    ...
    <div class="container">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="user">
                    <img src="assets/imgs/hyunjin.<a href="contact.php"><img src="assets/imgs/hyunjin.jpg" alt=""></a>" alt="">
                </div>
            </div>
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>User Data</h2>
                        <a href="u_insert.php" class="btn">Add New User</a>
                    </div>
					...
					while($row=mysqli_fetch_array($query)){
                        ...
                        <td><?php echo $row['password']; ?></td>
							...
							<a class="youn" href="u_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
						</tr>
						<?php
					}
				?>
